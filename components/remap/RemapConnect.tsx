...
export function RemapConnect() {
  const setRemapConnection = useWizardStore(s => s.setRemapConnection)
  ...
  async function handleConnect() {
    ...
    try {
      ...
      setRemapConnection(loginName, apiKey, data.baseUrl, data.companyName)
    } catch (e: unknown) {
    ...
    <div className="max-w-md mx-auto">
      <div className="mb-10">
        ...
        <p className="text-base text-gray-500 mt-2">
          We&apos;ll pull this account&apos;s existing products and match them against the SRS catalog.
        </p>
      </div>
